...
class IOperation(ABC):
    ...
    def execute(self, state, is_protein=False, comments=None, status=""):
        """
        ...
        Args:
            ...
            comments (List[Dict[str, str]], optional): List of comments for this operation
            status (str, optional): Status string for this operation
